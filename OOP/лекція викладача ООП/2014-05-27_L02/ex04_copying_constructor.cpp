...
public:
	...
	// на відміну від поверхневого побайтового копіювання
	Seller( Seller & objSource )
		: firstName(0), surName(0)
		  , age( objSource.age )
		  , averagePaymentsPercent( objSource.averagePaymentsPercent )
		  , isCalculated( objSource.isCalculated )
	{
		cout <<"\n Copying constructor works !!!\n ";
		setFirstName( objSource.firstName );
		setSurName( objSource.surName );
	}
	/////////////////////////////////////////////////////////
