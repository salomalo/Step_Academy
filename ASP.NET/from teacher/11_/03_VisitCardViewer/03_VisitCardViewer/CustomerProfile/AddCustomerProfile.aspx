...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:FormView ID="fvAddCustomer" runat="server" DefaultMode="Insert" DataKeyNames="Id" DataSourceID="dsCustomers">
        <InsertItemTemplate>
            <div class="registerCardContainer">
                <div class="row">
                    <div class="rowTitle">
                        <asp:Label ID="lblName" runat="server" Text="olol" ></asp:Label>
                      <%--  <asp:Label ID="lblName" runat="server" Text="<%$ Resources:strings, txtName %>"></asp:Label>--%>
                    </div>
