...
namespace _003_StronglyTypedDataSet_part2.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_TotalMarks = 1 AND [TotalMarks] IS NULL) OR ([TotalMarks] = @Original_TotalMarks)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Gender], [TotalMarks]) VALUES (@Name, @Gen" +
                "der, @TotalMarks);\r\nSELECT Id, Name, Gender, TotalMarks FROM Students WHERE (Id " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Name] = @Name, [Gender] = @Gender, [TotalMarks] = @TotalMarks WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_TotalMarks = 1 AND [TotalMarks] IS NULL) OR ([TotalMarks] = @Original_TotalMarks)));
SELECT Id, Name, Gender, TotalMarks FROM Students WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_003_StronglyTypedDataSet_part2.Properties.Settings.Default.db19hoursConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Gender, global::System.Nullable<int> Original_TotalMarks) {
        ...
        public virtual int Update(string Name, string Gender, global::System.Nullable<int> TotalMarks, int Original_Id, string Original_Name, string Original_Gender, global::System.Nullable<int> Original_TotalMarks, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, global::System.Nullable<int> TotalMarks, int Original_Id, string Original_Name, string Original_Gender, global::System.Nullable<int> Original_TotalMarks) {
            return this.Update(Name, Gender, TotalMarks, Original_Id, Original_Name, Original_Gender, Original_TotalMarks, Original_Id);
        }
    }
